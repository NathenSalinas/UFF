...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Watermark, "Calibri", 14, 500, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Menu, "Tahoma", 12, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Verdana", 12, 700, 0, 0, FONTFLAG_NONE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Verdana", 12, 800, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
